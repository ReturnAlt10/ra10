...
// BTEC Sport Unit 2 — Question Bank App
(function() {
'use strict';
...
const SESSION_TYPES = [
  'quiz_sport_u1', 'practice_sport_u1', 'mock_sport_u1', 'flashcard_sport_u1',
...
const GUIDE_FULL_UNLOCK_EXPIRY_KEY = 'ra10_guide_full_unlock_sport_u2_expires_at';
  ...
  aims.forEach((aim) => {
    ...
    topics.forEach((topic, idx) => {
      ...
      entries.push({
        ...
        code,
        title,
        summary: `Understand ${title.toLowerCase()} and apply it to sport performance contexts for Aim ${aim}.`,
...
function diagramSvgForSection(section) {
  if (section === 'C') {
    return '<svg viewBox="0 0 420 180" class="source-svg" role="img" aria-label="Nutrition and energy balance diagram"><rect x="1" y="1" width="418" height="178" rx="10" fill="#f8fafc" stroke="#cbd5e1"/><circle cx="100" cy="90" r="38" fill="#fef9c3" stroke="#ca8a04"/><text x="100" y="86" text-anchor="middle" font-size="11">Nutrients</text><text x="100" y="100" text-anchor="middle" font-size="9">Carbs, Protein, Fat</text><path d="M138 90 L282 90" stroke="#334155" stroke-width="3" marker-end="url(#a)"/><rect x="282" y="60" width="110" height="60" rx="10" fill="#dbeafe" stroke="#1d4ed8"/><text x="337" y="86" text-anchor="middle" font-size="11">Energy balance</text><text x="337" y="100" text-anchor="middle" font-size="9">Intake = Expenditure</text><text x="210" y="32" text-anchor="middle" font-size="11">Hydration supports all systems</text><defs><marker id="a" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#334155"/></marker></defs></svg>';
  }
  if (section === 'D') {
    return '<svg viewBox="0 0 420 180" class="source-svg" role="img" aria-label="Training methods and fitness diagram"><rect x="1" y="1" width="418" height="178" rx="10" fill="#f8fafc" stroke="#cbd5e1"/><rect x="24" y="34" width="120" height="46" rx="8" fill="#dbeafe" stroke="#1d4ed8"/><text x="84" y="62" text-anchor="middle" font-size="11">Aerobic endurance</text><rect x="150" y="34" width="120" height="46" rx="8" fill="#dcfce7" stroke="#16a34a"/><text x="210" y="62" text-anchor="middle" font-size="11">Strength / Power</text><rect x="276" y="34" width="120" height="46" rx="8" fill="#fef9c3" stroke="#ca8a04"/><text x="336" y="62" text-anchor="middle" font-size="11">Speed / Agility</text><line x1="84" y1="82" x2="84" y2="120" stroke="#334155"/><line x1="210" y1="82" x2="210" y2="120" stroke="#334155"/><line x1="336" y1="82" x2="336" y2="120" stroke="#334155"/><rect x="30" y="120" width="108" height="40" rx="6" fill="#e2e8f0" stroke="#64748b"/><text x="84" y="144" text-anchor="middle" font-size="10">Continuous / Interval</text><rect x="156" y="120" width="108" height="40" rx="6" fill="#e2e8f0" stroke="#64748b"/><text x="210" y="138" text-anchor="middle" font-size="10">Resistance /</text><text x="210" y="150" text-anchor="middle" font-size="10">Plyometrics</text><rect x="282" y="120" width="108" height="40" rx="6" fill="#e2e8f0" stroke="#64748b"/><text x="336" y="138" text-anchor="middle" font-size="10">Sprints /</text><text x="336" y="150" text-anchor="middle" font-size="10">Agility drills</text></svg>';
  }
...
function renderMock(mock) {
  ...
  wrap.appendChild(el('div', { class: 'paper-header' },
    el('h3', null, 'BTEC Level 3 Sport — Unit 2: Fitness Training and Programming'),
