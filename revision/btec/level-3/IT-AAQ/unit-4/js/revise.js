...
(function () {
  ...
  const FLASH_KEY = 'ra10_u4_flash_known';
...
<div class="quiz-stage">
  ...
  function renderQuizResults(host) {
    ...
    try {
      const prev = Number(localStorage.getItem('ra10_u4_best_quiz') || 0);
      if (pct > prev) localStorage.setItem('ra10_u4_best_quiz', String(pct));
    } catch (e) {}
...
<div class="flash-stage">
  ...
  window.u4ReviseReinit = function () {
    loadKnown();
  };
})();