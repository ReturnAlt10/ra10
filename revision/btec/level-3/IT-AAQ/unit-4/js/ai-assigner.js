...
(function () {
  ...
  function render() {
    ...
    if (!chatHistory.length) {
      addMsg('bot', 'Hi! I\u2019m **AI Assigner**, your Unit 4 mentor. Ask me about databases, normalisation and SQL, get **hints** on a task, or switch to **Examiner** to upload your work and have it checked against the real Pass/Merit/Distinction criteria.');
      renderSuggestions();
    }
  }
  ...
  function renderSuggestions() {
    ...
    var suggestions = [
      ...
      'Walk me through 1NF, 2NF and 3NF with an example',
      'What should go in my data dictionary?',
  ...
  async function doExamine() {
    ...
    try {
      ...
      var res = await RA10.markAssignment({ submission: text, taskTitle: 'Unit 4 assignment', criteria: criteriaMap });
      removeThinking(think);
