...
function addExpandedQuestionBank() {
  const banks = {
    A: [
      ...
      ['Analyse why SQL injection is a risk to a web application.', 6, 'A1.2 External threats — hacking'],
      ...
      ['Explain how a man-in-the-middle attack can intercept data.', 4, 'A1.2 External threats — hacking (DoS/DDoS)']
    ],
    B: [
      ...
      ['Describe the purpose of a demilitarised zone.', 3, 'B2.1 Hardware components'],
      ...
      ['Explain how a demilitarised zone improves network security.', 4, 'B2.1 Hardware components'],
...
function addExpandedQuestionBank2() {
  const banks = {
    A: [
      ...
      ['Describe how ARP spoofing works.', 4, 'A1.2 External threats — hacking (DoS/DDoS)'],
      ['Explain how session hijacking can allow an attacker to take over a user session.', 4, 'A1.2 External threats — hacking (DoS/DDoS)'],
      ['Describe what DNS poisoning is.', 3, 'A1.2 External threats — hacking (DoS/DDoS)'],
      ['State what SQL injection targets.', 2, 'A1.2 External threats — hacking'],
      ['Explain how XSS can steal data from a web user.', 4, 'A1.2 External threats — hacking'],
      ['Describe what CSRF is.', 3, 'A1.2 External threats — hacking'],
    ...
    B: [
      ...
      ['Explain how DNSSEC increases the security of DNS.', 4, 'B3.4 Network infrastructure services — DNS'],
      ...
      ['Explain the difference between RADIUS and TACACS+.', 4, 'B3.4 Network infrastructure services — authentication'],
      ...
      ['Explain the purpose of IPsec in a VPN.', 4, 'B3.4 Network infrastructure services — remote access']
    ],
    C: [
