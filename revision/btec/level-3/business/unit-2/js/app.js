/* ============================================================
   BTEC Business Unit 2 — Developing a Marketing Campaign
...
(function () {
  ...
  const FLASH_STORE_KEY  = 'btec-bus-u2-flash-progress-v1';
  const SESSION_TYPES = [
    'quiz_business_u2', 'practice_business_u2', 'mock_business_u2', 'flashcard_business_u2',
    'quiz', 'practice', 'mock', 'flashcard'
  ];

  // ---------- Spec (Business Unit 2) ----------
  const SPEC = {
    A: {
      title: 'Principles and Purposes of Marketing',
      short: 'Role of marketing, aims, markets, branding, influences',
      topics: [
        { code: 'A1', name: 'The role of marketing' },
        { code: 'A1.1', name: 'Principles: anticipating, recognising, stimulating, satisfying demand' },
        { code: 'A1.2', name: 'Marketing aims and objectives' },
        { code: 'A1.3', name: 'Mass vs niche markets; market segmentation' },
        { code: 'A1.4', name: 'Branding, brand personality, image, USP; implications of business size' },
        { code: 'A2', name: 'Influences on marketing activity' },
        { code: 'A2.1', name: 'Internal influences: cost, finance, staff, size and culture' },
        { code: 'A2.2', name: 'External influences: social, technological, economic, environmental, political, legal, ethical' }
      ]
    },
    B: {
      title: 'Information for the Rationale',
      short: 'Market research methods, data, product life cycle',
      topics: [
        { code: 'B1', name: 'Purpose of researching customer needs' },
        { code: 'B1.1', name: 'Identifying target markets, market size/trends, competition' },
        { code: 'B2', name: 'Market research methods and use' },
        { code: 'B2.1', name: 'Primary and secondary research' },
        { code: 'B2.2', name: 'Validity, reliability, appropriateness, currency, cost' },
        { code: 'B2.3', name: 'Quantitative and qualitative data' },
        { code: 'B3', name: 'Developing the rationale' },
        { code: 'B3.1', name: 'Interpretation of data; product life cycle' }
      ]
    },
    C: {
      title: 'Planning the Campaign',
      short: 'Situational analysis, marketing mix, campaign content',
      topics: [
        { code: 'C1', name: 'Marketing campaign activity' },
        { code: 'C1.1', name: 'Aims, SWOT and PESTLE, target market, competitor analysis' },
        { code: 'C2', name: 'Marketing mix' },
        { code: 'C2.1', name: 'Product, pricing strategies, promotion, place' },
        { code: 'C2.2', name: 'Extended marketing mix: people, physical environment, process' },
        { code: 'C3', name: 'The marketing campaign' },
        { code: 'C3.1', name: 'Message, media, budget allocation, timeline, evaluation' },
        { code: 'C4', name: 'Appropriateness of the campaign' },
        { code: 'C4.1', name: 'Brand value, sustainability, flexibility, legal and ethical considerations' }
      ]
    },
    D: {
      title: 'Developing the Campaign',
      short: 'Evaluation, flexibility, legal and ethical compliance',
      topics: [
        { code: 'D1', name: 'Legal and ethical considerations' },
        { code: 'D1.1', name: 'Truthful advertising, data protection, consumer protection' },
        { code: 'D2', name: 'Evaluation of the campaign' },
        { code: 'D2.1', name: 'Measuring against aims, ROI, flexibility and adaptation' }
      ]
    }
  };
  ...
  async function saveSession(sessionType, data) {
    ...
    try {
      ...
      if (!payload.total && sessionType !== 'flashcard_business_u2') return;
  ...
  const GUIDE_FULL_UNLOCK_EXPIRY_KEY = 'ra10_guide_full_unlock_business_u2_expires_at';
  ...
  function renderGuideAccessGate(container, aimASection) {
    ...
    card.innerHTML = timedUnlockActive
      ...
      `
      : `
        <h4 style="margin-top:0">Aims B-D are locked</h4>
  ...
  function renderMock(mock) {
    ...
    wrap.appendChild(el('div', { class: 'paper-header' },
      el('h3', null, 'BTEC Level 3 Business — Unit 2: Developing a Marketing Campaign'),
  ...
  async function endPracticeSession() {
    ...
    await saveSession('practice_business_u2', {
  ...
  async function renderProgress() {
    ...
    const typeLabel = {
      'quiz_business_u2': '🧠 Quiz',
      'practice_business_u2': '✍️ Practice',
      'mock_business_u2': '📄 Mock Paper',
      'flashcard_business_u2': '🃏 Flashcards',
  ...
  async function endFlashSession() {
    ...
    await saveSession('flashcard_business_u2', {
